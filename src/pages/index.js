    ...
    <Section id="about-me">
      ...
      <Flex alignItems='center' flexDirection='column'>
        <Box px={2} width={[ 1 , 1 / 2 ]}>
          <p>Currently, I am working as a Senior Solutions Architect at <Link to='https://missioncloud.com'>Mission</Link>, helping our customers with various problems related to doing business in the cloud. I care deeply about serverless and modern application development and continuously find ways to help my clients unlock value by switching from old school development methodologies to current approaches. Riding my mountain bike is one thing I do for fun.</p>
        </Box>
      </Flex>
    </Section>
